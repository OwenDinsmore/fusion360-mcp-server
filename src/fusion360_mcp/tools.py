...
TOOLS: list[dict] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "with its SIGN set by which side of the pinion the rack sits on: "
            "the rack moves with omega x r at the contact point. The wrong "
            "sign is not obvious — the sweep stays periodic and reads small "
            "at the phase points, then spikes mid-roll as the teeth drive "
            "into each other. The right sign gives a flat profile.\n\n"
